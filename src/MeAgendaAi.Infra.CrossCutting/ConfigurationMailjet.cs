...
{
	public static IServiceCollection ConfigureServiceAndHttpClientMailJet(this IServiceCollection services,
	...
	private static IServiceCollection ConfigureMailSender(this IServiceCollection services,
		ConfigurationManager configuration)
	{
	...
	private static ConfigurationMailJet ConfigureOptions(IServiceCollection services,
		ConfigurationManager configuration)
	{
