...
namespace MeAgendaAi.Infra.CrossCutting
{
    public static class ConfigurationJWT
    {
        ...
        public static TokenConfiguration CreateTokenCofiguration(IServiceCollection services, ConfigurationManager configuration)
        {
        ...
        private static void AddAuthentication(IServiceCollection services, TokenConfiguration tokenConfiguration, SigningConfiguration signingConfiguration)
        {
