...
namespace MeAgendaAi.Common.Builder.RequestAndResponse
{
    ...
    public static class AuthenticateResponseBuilderExtensions
    {
        ...
        public static AuthenticateResponseBuilder WithCreatedAt(this AuthenticateResponseBuilder builder, DateTime createdAt)
        {
            builder.RuleFor(prop => prop.CreatedAt, () => createdAt);
            return builder;
        }

        public static AuthenticateResponseBuilder WithLastUpdatedAt(this AuthenticateResponseBuilder builder, DateTime? lastUpdatedAt)
        {
