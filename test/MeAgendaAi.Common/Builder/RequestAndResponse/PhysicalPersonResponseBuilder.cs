...
namespace MeAgendaAi.Common.Builder.RequestAndResponse
{
    ...
    public static class PhysicalPersonResponseBuilderExtensions
    {
        ...
        public static PhysicalPersonResponseBuilder WithFullName(this PhysicalPersonResponseBuilder builder, string fullName)
        {
        ...
        public static PhysicalPersonResponseBuilder WithPhysicalPerson(this PhysicalPersonResponseBuilder builder, PhysicalPerson physicalPerson)
        {
            builder
